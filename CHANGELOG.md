...
- Read positional arguments from stdin when piped ([#98](https://github.com/wadackel/ofsht/pull/98))
...
- Add actions write permission for homebrew tap workflow dispatch ([#74](https://github.com/wadackel/ofsht/pull/74))
...
- Enhance worktree display with name column and aligned formatting ([#55](https://github.com/wadackel/ofsht/pull/55))


### Dependencies

- Update github-actions (third-party) ([#50](https://github.com/wadackel/ofsht/pull/50))

- Update github-actions (official) (major) ([#49](https://github.com/wadackel/ofsht/pull/49))


### Miscellaneous

- Release v0.3.0 ([#53](https://github.com/wadackel/ofsht/pull/53))
...
- Release v0.3.0 ([#48](https://github.com/wadackel/ofsht/pull/48))
...
- Resolve release-plz authentication failure with GitHub App token ([#18](https://github.com/wadackel/ofsht/pull/18))
